...
:start_recovery
echo Start flashing ..
fastboot flash splashscreen splashscreen_z008.img
fastboot flash token bom-token_4_21_40_x.bin
fastboot flash dnx dnx_4_21_40_x.bin
fastboot flash ifwi ifwi_4_21_40_112_z008.bin
fastboot flash fastboot droidboot_4_21_40_112.img
...
:flash_recovery
fastboot flash recovery twrp-3.2.1-0-z008.img
